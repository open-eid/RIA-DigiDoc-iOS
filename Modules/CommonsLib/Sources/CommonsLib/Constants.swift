...
public struct Constants {
    ...
    public struct Configuration {
        ...
        public static let CachedConfigPub = "active-config.ecpub"
        public static let CachedConfigRsa = "active-config.ecc"
        public static let CacheConfigFolder = "config"

        public static let DefaultConfigJson = "\(CacheConfigFolder)/default-config.json"
        public static let DefaultConfigPub = "\(CacheConfigFolder)/default-config.ecpub"
        public static let DefaultConfigRsa = "\(CacheConfigFolder)/default-config.ecc"

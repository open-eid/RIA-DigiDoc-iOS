...
final class SignedContainerTests {
    ...
    init() async throws {
        ...
        let configurationProperties = ConfigurationProperties(suiteName: "SignedContainerTests")
        ...
        try await configurationLoader.initConfiguration(cacheDir: SignedContainerTests.cacheDir)
